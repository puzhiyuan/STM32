 ...
 * @Date: 2023-02-27 10:30:27
 * @LastEditors: puzhiyuan puzhiyuan185489643@gmail.com
 * @LastEditTime: 2023-04-07 16:55:22
 * @FilePath: \stm32\NET\onenet.c
 * @Description: 
 * 
...
#define USER		"pzy"
#define PASSWORD	"666777"
#define DEVID		"zhiyuan666"

extern unsigned char esp8266_buf[128];

/**
 * @description: 与MQTT服务器建立连接
 * @return {*} 1-成功	0-失败
 */
_Bool OneNet_DevLink(void)
{
	...
	_Bool status = 1;
	UsartPrintf(USART_DEBUG, "Link_MQTT_Server...\r\n");
	if(MQTT_PacketConnect(USER, PASSWORD, DEVID, 256, 0, MQTT_QOS_LEVEL0, NULL, NULL, 0, &mqttPacket) == 0)
	{
		...
		if(dataPtr != NULL)
		{
			...
			UsartPrintf(USART_DEBUG, "云平台无响应...\r\n");
		}
	...
	switch(type)
	{
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				if (!json)
				{
					UsartPrintf(USART_DEBUG, "Error before: [%s]", cJSON_GetErrorPtr());
				}else{
