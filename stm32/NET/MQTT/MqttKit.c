 ...
 * @param {uint8} *rev_data
 * @param {int8} *
 * @param {uint16} *topic_len
 * @param {int8} *
 * @param {uint16} *payload_len
 * @param {uint8} *qos
 * @param {uint16} *pkt_id
 * @return {*}
 */
...
/**
 * @description: Publish Ack消息组包  (当收到的Publish消息的QoS等级为1时，需要Ack回复)
 * @param {uint16} pkt_id packet id
 * @param {MQTT_PACKET_STRUCTURE} *mqttPacket 包指针
 * @return {*} 0-成功		1-失败原因
 */
...
/**
 * @description: Publish Rec消息组包  (当收到的Publish消息的QoS等级为2时，先收到rec)
 * @param {uint16} pkt_id packet id
 * @param {MQTT_PACKET_STRUCTURE} *mqttPacket 包指针
 * @return {*} 0-成功	1-失败
 */
...
/**
 * @description: Publish Rel消息组包 (当收到的Publish消息的QoS等级为2时，先收到rec，再回复rel)
 * @param {uint16} pkt_id packet id
 * @param {MQTT_PACKET_STRUCTURE} *mqttPacket 包指针
 * @return {*} 0-成功	1-失败
 */
...
/**
 * @description: Publish Comp消息组包 (当收到的Publish消息的QoS等级为2时，先收到rec，再回复rel)
 * @param {uint16} pkt_id packet id
 * @param {MQTT_PACKET_STRUCTURE} *mqttPacket 包指针
 * @return {*} 0-成功	1-失败
 */
